...
from inventory.models import Order, Variant
...
class OrderFilter(filters.FilterSet):
    assigned_status = filters.BooleanFilter(method="assigned_status_filter")

    class Meta:
        model = Order
        fields = ["status"]

    def assigned_status_filter(self, queryset, name, value):
        if value == False:
